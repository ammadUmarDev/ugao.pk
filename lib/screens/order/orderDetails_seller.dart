...
class orderDetailsSeller extends StatefulWidget {
  ...
  orderDetailsSeller({Key key, this.orderID}) : super(key: key);
  _orderDetailsSellerState createState() =>
      _orderDetailsSellerState(orderID: this.orderID);
}
...
class _orderDetailsSellerState extends State<orderDetailsSeller> {
  ...
  _orderDetailsSellerState({Key key, String orderID}) {
                ...
                children: <Widget>[
                  ...
                  new Row(
                    children: <Widget>[
                      Expanded(
                          child: Text(
                              "Customer Address: " + selectedOrder.address)),
                    ],
                  ),
                  new Row(
                    children: <Widget>[
